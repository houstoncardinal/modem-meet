...
import { ArrowLeft, MapPin, Globe, Edit } from "lucide-react";
        ...
        <Card className="border-2 border-primary bg-card p-8">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6">
              <div className="w-24 h-24 rounded-none bg-primary/20 border-2 border-primary flex items-center justify-center text-primary font-bold text-4xl">
